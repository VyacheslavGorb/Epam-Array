...
public class ArrayCreatorTest {
    ...
    public void testCreateArrayEntity(String fileName, IntArray expectedValue) throws FileException, ValidityException {
    ...
    public void testCreateArrayEntityException(String fileName) throws FileException, ValidityException {
        var array = creator.createArrayEntity(fileName);
    }
    ...
    public Object[][] createFileRecords() {
        return new Object[][]{
                {projectFolder + "./src/test/resources/testReader1.txt", new IntArray(1, 2, 3, 4, 5, 6)},
                {projectFolder + "./src/test/resources/testReader2.txt", new IntArray(43, 2, 6, 3, 2, 5, 6)}
        };
    }
